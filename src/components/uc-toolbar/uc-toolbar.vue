	...
	<div class="foot-btn">
	  <ul>
	    ...
	    <li class="zan"><a href="javascript:;">
	      <i style="width:0.36rem;height:0.28rem; background:url(./images/zan1.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.54rem; margin-top:0.13rem;"></i><span>0</span>
	      </a></li>
